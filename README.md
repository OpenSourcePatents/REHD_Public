...
> **Note on Mode 3:** Mode 3 content has been redacted from the public release pending ITAR and Invention Secrecy Act review. The unrestricted version is available to verified U.S. DoD/military personnel upon request. See <Docs/legal/RESTRICTED_ACCESS.md> for details.
...
└── LICENSE                            ← Apache 2.0 — open source, no royalty, no charge, ever
```
...
See <ADMIRAL_BOXALL.md> for the full message.
